"""NavigationUiCommander: delegates navigation requests without interpreting payloads."""
...
class NavigationUiCommander:
    def __init__(self, target: UiNavigationMessenger):
        self._target = target
