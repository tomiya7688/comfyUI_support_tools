...
class NativeArtifactInventoryTests(unittest.TestCase):
    def test_attributes_python_native_runtime_libraries_separately(self):
        with tempfile.TemporaryDirectory() as temporary_directory:
            ...
            artifact_names = ["libcrypto-1_1.dll", "libffi-7.dll", "_bz2.pyd", "_lzma.pyd", "_decimal.pyd", "pyexpat.pyd", "VCRUNTIME140.dll"]
            entries = []
            ...
            components = [
                ...
                {"name": "libmpdec", "version": "2.5.1", "license_files": ["licenses/Python/LICENSE.txt", "licenses/libmpdec/LICENSE.txt"]},
                {"name": "Expat", "version": "2.5.0", "license_files": ["licenses/Python/LICENSE.txt", "licenses/expat/LICENSE.txt"]},
        ...
        self.assertEqual(by_path["_decimal.pyd"]["origin_component"], "libmpdec")
        self.assertEqual(by_path["_decimal.pyd"]["origin_version"], "2.5.1")
        self.assertEqual(by_path["_decimal.pyd"]["license_files"], ["licenses/Python/LICENSE.txt", "licenses/libmpdec/LICENSE.txt"])
        self.assertEqual(by_path["pyexpat.pyd"]["origin_component"], "Expat")
        self.assertEqual(by_path["pyexpat.pyd"]["origin_version"], "2.5.0")
        self.assertEqual(by_path["pyexpat.pyd"]["license_files"], ["licenses/Python/LICENSE.txt", "licenses/expat/LICENSE.txt"])
