"""UiNavigationMessenger: delegates navigation requests without interpreting payloads."""
...
class UiNavigationMessenger:
    def __init__(self, target: ProcessNavigationMessenger):
        self._target = target
